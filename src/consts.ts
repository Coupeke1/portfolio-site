...
export const SITE_URL = 'https://mathiasmeeus.dev';
export const SITE_GITHUB = 'https://github.com/Coupeke1';
export const SITE_LINKEDIN = 'https://www.linkedin.com/in/mathias-meeus-a92bb9250/';
export const SITE_INSTAGRAM = 'https://www.instagram.com/mathiasmeeus/';
